...
Fetch all segments for a profile, categorize them, flag anything outdated, and compare against the six core automation categories.
...
- Underperformer Pausing (keywords/targets — `set_state` pause on proven unprofitable spend)
- Other (anything that doesn't map cleanly)

### Step 4 — Coverage Analysis

Compare against the six core automation categories. Report what's covered (✅) and what's missing (❌).
