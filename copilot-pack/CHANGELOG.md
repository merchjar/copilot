...
- The public API reference now lives on the website (rendered from the OpenAPI contract). The in-pack reference was retired; use the canonical page and its downloadable OpenAPI specification instead.
